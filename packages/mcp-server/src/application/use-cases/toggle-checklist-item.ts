import { createChecklistItemToggledEvent } from '../../domain/events/checklist-event-factories.js';
...
export class ToggleChecklistItemUseCase {
  ...
  execute(input: Input): Result {
    ...
    const event = createChecklistItemToggledEvent({
    ...
    return { itemId: input.itemId, completed: input.completed };
  }
}
